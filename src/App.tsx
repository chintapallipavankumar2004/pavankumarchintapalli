...
const DESCRIPTION =
  "Websites, web applications, and visual designs for businesses and personal brands. Explore Pavan Kumar’s work and discuss your next project.";
...
function HomePage() {
  useEffect(() => {
    ...
    ensureMeta('meta[name="keywords"]', {
      name: "keywords",
      content:
        "Software Developer, Freelancer, Java Developer, Spring Boot Developer, Full Stack Developer, Freelance Web Developer, Chintapalli Pavan Kumar",
    });
    ensureMeta('meta[name="author"]', {
      name: "author",
      content: "Chintapalli Pavan Kumar",
    });
    ...
    let structuredData = document.getElementById("person-schema");
    if (!structuredData) {
      structuredData = document.createElement("script");
      structuredData.id = "person-schema";
